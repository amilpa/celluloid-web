...
export default function Home() {
  return (
    <div className="hero bg-base-100 min-h-screen  max-h-screen overflow-hidden absolute top-0 -z-10">
      ...
      <div className="bg-success pointer-events-none absolute top-[48%] left-[50%] start-20 aspect-square w-full rounded-full opacity-10 blur-3xl [transform:translate3d(0,0,0)]"></div>
      <div className="hero-content text-center mt-8">
        <div className="flex flex-col items-center">
          ...
          <button className="btn btn-lg btn-wide relative">
